...
const (
	Updater_GetAvailableUpdateBundles_FullMethodName     = "/swupdate.Updater/GetAvailableUpdateBundles"
	Updater_InstallUpdateBundle_FullMethodName           = "/swupdate.Updater/InstallUpdateBundle"
	Updater_Reboot_FullMethodName                        = "/swupdate.Updater/Reboot"
	Updater_GetStatus_FullMethodName                     = "/swupdate.Updater/GetStatus"
	Updater_Rollback_FullMethodName                      = "/swupdate.Updater/Rollback"
...
func (c *updaterClient) GetAvailableUpdateBundles(ctx context.Context, in *GetAvailableUpdateBundlesRequest, opts ...grpc.CallOption) (*GetAvailableUpdateBundlesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Updater_GetAvailableUpdateBundles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updaterClient) InstallUpdateBundle(ctx context.Context, in *InstallUpdateBundleRequest, opts ...grpc.CallOption) (Updater_InstallUpdateBundleClient, error) {
	stream, err := c.cc.NewStream(ctx, &Updater_ServiceDesc.Streams[0], Updater_InstallUpdateBundle_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *updaterClient) Reboot(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Updater_Reboot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updaterClient) GetStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Updater_GetStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updaterClient) Rollback(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RollbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, Updater_Rollback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updaterClient) GetClientInformation(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetClientInformationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Updater_GetClientInformation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updaterClient) GetInstalledBundleInformation(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetInstalledBundleInformationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Updater_GetInstalledBundleInformation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Updater_GetAvailableUpdateBundles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_GetAvailableUpdateBundles_FullMethodName,
	}
...
func _Updater_Reboot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_Reboot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Updater_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_GetStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Updater_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_Rollback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Updater_GetClientInformation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_GetClientInformation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Updater_GetInstalledBundleInformation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_GetInstalledBundleInformation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Updater_ExecuteMonitoredCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteMonitoredCommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UpdaterServer).ExecuteMonitoredCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Updater_ExecuteMonitoredCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UpdaterServer).ExecuteMonitoredCommand(ctx, req.(*ExecuteMonitoredCommandRequest))
	}
	return interceptor(ctx, in, info, handler)
}
